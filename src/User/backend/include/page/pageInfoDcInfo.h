...
namespace page
{
    ...
    static QList<PageField> infoDcInfoPageFieldList = {
        ...
        {"LoadBreaker",                 "short",    2,      0x12,       0xF1,       0x01,   },
        {"ShareBreaker",                "short",    2,      0x12,       0xF7,       0x09,   },
    ...
    const static QList<QByteArray> infoDcInfoPageQuerryCmdList = {
        ...
        QByteArray::fromHex("321100"),
        QByteArray::fromHex("321200"),
        QByteArray::fromHex("321300"),
    ...
    private:
        ...
        static QList<PageField> &initinfoDcInfoPageFieldList();
